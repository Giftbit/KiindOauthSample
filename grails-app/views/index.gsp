...
<div id="welcome" class="maincontent">
    <h2>Welcome to the Kiind Oauth sample app</h2>
    ...
    need to implement in your application to  securely retrieve Kiind API and Refresh tokens for your users, and use them to make API calls to Kiind on their behalf.

    <h3>Where do I start?</h3>

    <p>In order to understand each step in the process,
    read through the <a href="http://resources.kiind.me/api/KiindOauth-latest.pdf">Kiind OAuth documentation</a>.
    </p>

    <p>
        Once you are familiarized with the concepts and technical underpinnings, ensure you have an account set up on Kiind's testbed platform, and that you have an application registered
        with your account.
    ...
    <p>
        This sample app is meant to be a reference only for the request response flow to Kiind, and NOT as a reference or best practices guide for overall application design.
