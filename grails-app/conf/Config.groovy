kiind.apiEndpointBase='https://api.giftbit.com'
kiind.webEndpointBase='https://app.giftbit.com'

kiind.ApiVersion = "v2"

kiind.oauthWebLoginEndpoint='oauth/userlogin'
kiind.apiTokenEndpoint='oauth/token'
kiind.apiPaymentEndpoint='payment'

kiind.oauth.scopes=['PAYMENT','GIFT']
...
environments {
    development {
        ...
        kiind.apiEndpointBase='https://localhost:8443'
        kiind.webEndpointBase='https://localhost:8443'
    }

    testbed {
        kiind.apiEndpointBase='https://testbedapp.giftbit.com'
    ...
    mockapp {
        kiind.apiEndpointBase='https://mockapp.giftbit.com'
        kiind.webEndpointBase='https://mockapp.giftbit.com'
    }
...
/* Start default Grails Configuration */
...
/*End default grails configuration*/
